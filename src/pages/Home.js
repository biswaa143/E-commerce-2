...
const HomePage = () => {
  return (
    <Card className="text-center">
      <Card.Title style={{ fontSize: "2rem", marginBottom:'3rem'}}>TOURS</Card.Title>
      <Col>
        <div className="d-flex justify-content-between">
          ...
          <Button style={{backgroundColor:'rgb(26, 196, 238)', marginRight:'1.1rem'}}>BUY TICKETS</Button>
          <hr />
        </div>
        < hr />
        ...
        < hr />
          ...
          <Button style={{backgroundColor:'rgb(26, 196, 238)'}}>BUY TICKETS</Button>
          <hr />
        </div>
        < hr />
